...
const renderNavigate = async (args: ComponentArgs<['folder', 'template', 'date', 'dateFormat']>, el: HTMLElement, ctx: MarkdownPostProcessorContext, app: App, instance: ComponentInstance, componentSettings: Record<string, any> = {}) => {
